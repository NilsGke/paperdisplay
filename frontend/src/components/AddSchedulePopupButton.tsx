    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Select an image and a time and the Display will automatically apply
            the image every day at the specified time
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            >
              <img
                ...
                className={cn("w-full h-auto", { "opacity-0": image === "" })}
                style={{
                  aspectRatio: env.VITE_CANVAS_WIDTH / env.VITE_CANVAS_HEIGHT,
                }}
              />
